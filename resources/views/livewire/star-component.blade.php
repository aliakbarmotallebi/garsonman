<div>
    <ul class="flex justify-center mt-2">
        <li wire:click="setStar(5)" class="cursor-pointer">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="angry" class="w-8 hover:text-gray-500 text-blue-500 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        <li wire:click="setStar(4)" class="cursor-pointer">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="frown" class="w-8 hover:text-gray-500 text-blue-500 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        <li wire:click="setStar(3)" class="cursor-pointer">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="meh" class="w-8 hover:text-gray-500 text-blue-500 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        <li wire:click="setStar(2)" class="cursor-pointer">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="smile" class="w-8 hover:text-gray-500 text-blue-500 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        <li wire:click="setStar(1)" class="cursor-pointer">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="grin-stars" class="w-8 hover:text-gray-500 text-blue-500 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
